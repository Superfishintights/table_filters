...
var uniqueGenders = [...new Set(listData.map(item => item.gender))];

// Initialize Slim Select for Gender dropdown
var genderSelect = new SlimSelect({
    select: '#headerGender',
    data: [
        { text: 'Gender', value: '', disabled: true }, 
        ...uniqueGenders.map(value => ({ text: value, value: value }))
    ],
...
// Initialize filterRow and filterButton elements
var filterRow = document.getElementById("filterRow");
var filterButton = document.getElementById("filterButton");

// Initialize clearFilter button element
...
// Filter function
function filterData() {
    var selectedGenders = genderSelect.selected();
...
// Listen for change events on the Gender dropdown
document.getElementById("headerGender").addEventListener("change", filterData);
